...
const SpeedTrader = observer(() => {
    ...
    const confirmStart = () => {
        ...
        start({ symbols, initial_stake, martingale_mult, max_martingale_steps, stop_loss, take_profit, virtual_loss_mode });
    };
                ...
                <div className='speed-trader__col-main'>
                    <div className='speed-trader__panel'>
                            ...
                            <span className={`speed-trader__status ${state.is_armed ? 'live' : ''}`}>
                                {state.is_armed
                                    ? state.is_loading
                                        ? localize('Connecting…')
                                        : state.active_symbol
                                          ? localize('LIVE — trading {{symbol}}', {
                                                symbol: displayName(state.active_symbol),
                                            })
                        ...
                        <div className='speed-trader__controls-grid'>
                            ...
                            <label>
                                <span>{localize('Virtual loss target')}</span>
                                <select
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className='speed-trader__race-bar'>
                                                <div
                                                    className='speed-trader__race-bar-fill'
                                                    style={{ width: `${pct}%` }}
                                                />
                                            </div>
                ...
                <div className='speed-trader__confirm-overlay'>
                    <div className='speed-trader__confirm-box'>
                        ...
                        <p>
                            ...
                            {localize('take profit')} ${take_profit}, {localize('virtual loss target')}{' '}
                            {virtual_loss_mode === 'fixed' ? localize('5 (fixed)') : localize('3-5 (randomized)')}{' '}
                            {watch_all_markets
