...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, ANALYSIS_TOOL, FREE_BOTS, AUTOTRADE } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, CHART, ANALYSIS_TOOL, FREE_BOTS, AUTOTRADE].includes(active_tab) || active_tour;
