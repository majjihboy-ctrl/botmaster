...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, ANALYSIS_TOOL, FREE_BOTS } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, CHART, ANALYSIS_TOOL, FREE_BOTS].includes(active_tab) || active_tour;
