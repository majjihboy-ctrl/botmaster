        ...
        content: [
            <span key='step-2-wrapper'>
                {isGoogleDriveConfigured() ? (
                    ...
                    <Localize key='step-2' i18n_default_text='Next, import your bot directly from your mobile device.' />
                )}
            </span>,
        ],
        tour_step_key: 2,
...
export const getTourDialogAction = (is_mobile: boolean) => {
    if (is_mobile) {
        return isGoogleDriveConfigured() ? (
            ...
            <Localize
                key='tour-dialog-action-mobile'
                i18n_default_text='You can import a bot from your mobile device, see a preview in the bot builder, and start trading by running the bot.'
            />
        );
    }
    return '';
